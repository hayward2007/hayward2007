...
// // class Collider {
// //     leftTop: Coordinate2D;
// //     leftBottom: Coordinate2D;
// //     rightTop: Coordinate2D;
// //     rightBottom: Coordinate2D;

// //     constructor(leftTop: Coordinate2D, rotation: number, width: number, height: number) {
// //         this.leftTop = leftTop;
// //         this.rightTop = new Coordinate2D(leftTop.x + Math.cos(rotation) * width, leftTop.y - Math.sin(rotation) * width);
// //         this.leftBottom = new Coordinate2D(leftTop.x + Math.sin(rotation) * height, leftTop.y + Math.cos(rotation) * height);
// //         this.rightBottom = new Coordinate2D(leftTop.x + Math.cos(rotation) * width - Math.sin(rotation) * height, leftTop.y + Math.sin(rotation) * width + Math.cos(rotation) * height);
// //     }
// // }
